...
def test_getting_fave_show
  result = get_fave_show(@person5)
...
def test_check_like_food__true
  result = likes_to_eat(@person2, "bread")
  assert_equal(true, result)
end

def test_check_like_food__false
...
def test_lending_money
  lending_money(@person2, @person1, 1)
...
def test_fave_food_set
  result = fave_food_set(@people)
...
def test_no_friend_finder
  result = no_friend_finder(@people)
  assert_equal(1, result.length)

end


def test_no_friend_finder__checkperson
  result = no_friend_finder(@people)
  assert_equal(true, result.include?("Daphne"))
